...
export async function Analyzer_Buying_Counter(context: any) {
    ...
    const birthday: Achivied[] = [
        ...
        { uid: 92, name: "Покупка года", subname: ["Лучшая покупка", "Покупка года", "Самая крутая покупка"], description: "Купите самый дорогой предмет в косом переулке.", counter: 3 },
        { uid: 93, name: "Торговец года", subname: ["Лучший торговец", "Торговец года", "Самый успешный торговец"], description: "Продайте самый дорогой предмет в косом переулке.", counter: 7 },
        { uid: 94, name: "Завсегдатай косого переулка", subname: ["Регулярный покупатель", "Постоянный клиент", "Любимец торговцев"], description: "Совершите 5 покупок в косом переулке.", counter: 12 },
        { uid: 95, name: "Коллекционер", subname: ["Начинающий коллекционер", "Опытный коллекционер", "Профессиональный коллекционер"], description: "Купите все доступные виды питомцев, снаряжения для квиддича и волшебных палочек в косом переулке.", counter: 15 },
        { uid: 96, name: "Волшебная коллекция", subname: ["Начальная коллекция", "Средняя коллекция", "Лучшая коллекция"], description: "Купите все виды питомцев в косом переулке.", counter: 20 },
        { uid: 97, name: "Мастер квиддича", subname: ["Начинающий мастер", "Опытный мастер", "Профессиональный мастер"], description: "Купите все виды снаряжения для квиддича в косом переулке.", counter: 25 },
        { uid: 98, name: "Магический зоопарк", subname: ["Маленький зоопарк", "Средний зоопарк", "Большой зоопарк"], description: "Купите все доступные виды питомцев в косом переулке.", counter: 30 },
        { uid: 99, name: "Коллекционер палочек", subname: ["Начинающий коллекционер", "Опытный коллекционер", "Профессиональный коллекционер"], description: "Купите все виды волшебных палочек в косом переулке.", counter: 35 },
        { uid: 100, name: "Квиддичный фанат", subname: ["Начинающий фанат", "Опытный фанат", "Профессиональный фанат"], description: "Купите все виды снаряжения для квиддича и питомцев, связанных с квиддичем в косом переулке.", counter: 40 },
        { uid: 101, name: "Магический миллионер", subname: ["Начинающий миллионер", "Опытный миллионер", "Профессиональный миллионер"], description: "Потратьте 10000 галеонов в косом переулке.", counter: 45 },
        { uid: 102, name: "Лучший друг питомцев", subname: ["Начинающий друг", "Друг на все времена", "Лучший друг"], description: "Купите и выращивайте каждого питомца в косом переулке.", counter: 50 },
        { uid: 103, name: "Магический торговец", subname: ["Начинающий торговец", "Опытный торговец", "Профессиональный торговец"], description: "Продайте 100 предметов в косом переулке.", counter: 55 },
        { uid: 104, name: "Магический магнат", subname: ["Начинающий магнат", "Опытный магнат", "Профессиональный магнат"], description: "Потратьте 1000 галеонов в косом переулке.", counter: 60 },
        { uid: 105, name: "Король косого переулка", subname: ["Маленький король", "Средний король", "Великий король"], description: "Совершите 10 покупок питомцев, снаряжения для квиддича и волшебных палочек в косом переулке.", counter: 70 },
    ]
    if (analyzer) {
