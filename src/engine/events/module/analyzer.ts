...
export async function Analyzer_Underwear_Counter(context: any) {
    ...
    const birthday: Achivied[] = [
        ...
        { uid: 50, name: "Трусы-защитники", subname: ["Трусы-броня", "Трусы-щит", "Трусы-магический щит"], description: "Закладывайте в банку трусы, сделанные из материалов, которые обеспечивают защиту. Достигните указанного количества закладок, чтобы получить достижение.", counter: 25 },
        { uid: 51, name: "Трусы-исцелители", subname: ["Трусы-лекарство", "Трусы-амброзия", "Трусы-эликсир жизни"], description: "Закладывайте в банку трусы, обладающие целебными свойствами. Достигните указанного количества закладок, чтобы получить достижение.", counter: 50 },
        { uid: 52, name: "Трусы-переводчики", subname: ["Трусы-словарь", "Трусы-переводчик", "Трусы-магический переводчик"], description: "Закладывайте в банку трусы, которые позволяют понимать и говорить на разных языках. Достигните указанного количества закладок, чтобы получить достижение.", counter: 100 },
        { uid: 53, name: "Трусы-проекционисты", subname: ["Трусы-кинопроектор", "Трусы-голографический проектор", "Трусы-магический проектор"], description: "Закладывайте в банку трусы, которые позволяют создавать голограммы и проекции. Достигните указанного количества закладок, чтобы получить достижение.", counter: 200 },
        { uid: 54, name: "Трусы-телепорты", subname: ["Трусы-телепорт", "Трусы-портал", "Трусы-магический переход"], description: "Закладывайте в банку трусы, которые позволяют перемещаться на большие расстояния. Достигните указанного количества закладок, чтобы получить достижение.", counter: 400 },
        { uid: 55, name: "Трусы-маскировщики", subname: ["Трусы-камуфляж", "Трусы-переменная маскировка", "Трусы-магический камуфляж"], description: "Закладывайте в банку трусы, которые позволяют скрываться и маскироваться. Достигните указанного количества закладок, чтобы получить достижение.", counter: 800 },
        { uid: 56, name: "Трусы-перезарядки", subname: ["Трусы-перезарядка", "Трусы-магическая батарея", "Трусы-энергетический резервуар"], description: "Закладывайте в банку трусы, которые позволяют быстро восстанавливать магическую энергию. Достигните указанного количества закладок, чтобы получить достижение.", counter: 1200 },
        { uid: 57, name: "Трусы-взломщики", subname: ["Трусы-взломщик", "Трусы-взломщик замков", "Трусы-магический взломщик"], description: "Закладывайте в банку трусы, которые позволяют взламывать различные защитные механизмы. Достигните указанного количества закладок, чтобы получить достижение.", counter: 2500 },
        { uid: 58, name: "Трусы-магниты", subname: ["Трусы-магнит", "Трусы-магнитный щит", "Трусы-магнитный торнадо"], description: "Закладывайте в банку трусы, которые притягивают к себе различные предметы. Достигните указанного количества закладок, чтобы получить достижение.", counter: 5000 },
        { uid: 59, name: "Трусы-трансформеры", subname: ["Трусы-перевоплощение", "Трусы-трансформер", "Трусы-магический трансформер"], description: "Закладывайте в банку трусы, которые позволяют менять свой облик. Достигните указанного количества закладок, чтобы получить достижение.", counter: 10000 },
        { uid: 60, name: "Трусы-генераторы", subname: ["Трусы-генератор", "Трусы-магический генератор", "Трусы-энергетический генератор"], description: "Закладывайте в банку трусы, которые позволяют создавать энергию. Достигните указанного количества закладок, чтобы получить достижение.", counter: 20000 }
    ]
    if (analyzer) {
...
export async function Analyzer_Quest_Counter(context: any) {
    ...
    const birthday: Achivied[] = [
        ...
        { uid: 65, name: "Золотые запасы", subname: ["Золотой запас", "Серебряный запас", "Бронзовый запас"], description: "Сохраняйте свои галеоны в банке гринготтс и получайте проценты на свои вклады. Достигните указанного объема накоплений, чтобы получить достижение.", counter: 25 },
        { uid: 66, name: "Банковский меценат", subname: ["Начинающий меценат", "Опытный меценат", "Профессиональный меценат"], description: "Спонсируйте магические проекты и исследования, вложив свои галеоны в нужные фонды. Достигните указанного объема вложений, чтобы получить достижение.", counter: 50 },
        { uid: 67, name: "Банковский гений", subname: ["Начинающий гений", "Опытный гений", "Магический гений"], description: "Станьте экспертом в области банкинга и применяйте свои знания в своих ежедневных квестах. Достигните указанного уровня мастерства, чтобы получить достижение.", counter: 100 },
        { uid: 68, name: "Банковский босс", subname: ["Начальный босс", "Опытный босс", "Профессиональный босс"], description: "Станьте лидером в области банкинга и управляйте своими финансами с максимальной эффективностью. Достигните указанного уровня мастерства, чтобы получить достижение.", counter: 200 },
        { uid: 69, name: "Галеоны-магнат", subname: ["Начинающий магнат", "Опытный магнат", "Магнат-миллионер"], description: "Станьте настоящим магнатом и заработайте миллионы галеонов. Достигните указанного объема накоплений, чтобы получить достижение.", counter: 400 },
        { uid: 70, name: "Банковский император", subname: ["Начинающий император", "Опытный император", "Магический император"], description: "Станьте владельцем магической империи и управляйте несколькими банками гринготтс. Достигните указанного уровня мастерства, чтобы получить достижение.", counter: 800 },
        { uid: 71, name: "Банковский титан", subname: ["Начинающий титан", "Опытный титан", "Магический титан"], description: "Станьте настоящим титаном банкинга и управляйте огромными объемами капиталов. Достигните указанного объема накоплений, чтобы получить достижение.", counter: 1200 },
        { uid: 72, name: "Банковский бог", subname: ["Начинающий бог", "Опытный бог", "Магический бог"], description: "Станьте настоящим богом банкинга и обладателем несметных богатств. Достигните указанного объема накоплений, чтобы получить достижение.", counter: 2500 },
        { uid: 73, name: "Банковский король", subname: ["Начинающий король", "Опытный король", "Магический король"], description: "Станьте настоящим королем банкинга и управляйте всеми финансовыми потоками Хогвартса. Достигните указанного уровня мастерства, чтобы получить достижение.", counter: 5000 },
        { uid: 74, name: "Банковский бессмертный", subname: ["Начинающий бессмертный", "Опытный бессмертный", "Магический бессмертный"], description: "Станьте бессмертным в мире банкинга и продолжайте накапливать богатства без ограничений времени. Достигните указанного уровня мастерства, чтобы получить достижение.", counter: 10000 },
        { uid: 75, name: "Банковский легенда", subname: ["Начинающая легенда", "Опытная легенда", "Магическая легенда"], description: "Станьте настоящей легендой мира банкинга и управляйте всеми финансовыми потоками во всей Великой Британии. Достигните указанного уровня мастерства, чтобы получить достижение.", counter: 20000 }
    ]
    if (analyzer) {
