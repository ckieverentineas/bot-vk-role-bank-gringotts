    ...
    if (trigger_check.value == false) {
        if (context.eventPayload?.command_sub == 'beer_buying') {
            ...
            const questuin_pull = [
                ...
                { location: "Хогвартс", name: "Астрономическая Башня", quest: [ "Спеть песню «И камнем вниз...»", "Скинуть водные бомбочки с башни", "Подумать, почему солнце назвали солнцем", "Поиграть в догони меня кирпич", "Проверить перила на прочность" ] },
                ...
                { location: "Хогвартс", name: "Правый коридор | 5 этаж", quest: [ "Нарисовать на полу портрет профессора Макгонагалд", "Поиграть в классики", "Покривляться и построить смешные рожицы" ] },
                { location: "Хогвартс", name: "Деревянный мост", quest: [ "Спрыгнуть с моста в воду", "Посидеть на перилах", "Поиграть в шашки", "Проверить мост на прочность", "Скатиться с моста на скейте" ] },
                ...
                //Бристон
                { location: "Бристон", name: 'Стрип-клуб "MurMur angels-club"', quest: [ "Подача резюме на работу", "Подделка документов", "Кража конфеток с ресепшена" ] },
                ...
                { location: "Бристон", name: "ЗаМУРчательное кафе", quest: [ "Кошачья терапия", "Проверка заболевшего домашнего питомца", "Разложиться на стойке для заказов" ] },
                ...
                { location: "Бристон", name: "Больница", quest: [ "Украсть вкусняшки с ресепшена", "Похищение анализов", "Шпионство в окна больницы за работниками", "Кража кресла с ресепшена" ] },
                { location: "Бристон", name: "Мракоборческий участок", quest: [ "Кража ключей от решёток", "Выбить окно в участке", "Вынес всех важных документов " ] },
                { location: "Бристон", name: "Заповедник", quest: [ "Кража редких животных", "Перелезть через забор к домику лесника", "Спилить несколько деревьев" ] },
