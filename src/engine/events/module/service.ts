    ...
    if (trigger_check.value == false) {
        if (context.eventPayload?.command_sub == 'beer_buying') {
            ...
            const questuin_pull = [
                ...
                { location: "Хогвартс", name: "Кухня", quest: [ "Приготовить шарлотку", "Помочь эльфам", "Перемыть всю посуду", "Придумать новое оригинальное блюдо", "Составить меню для профессоров на день", "Испечь торт с портретом профессора и подарить" ] },
