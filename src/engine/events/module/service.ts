    ...
    if (trigger_check.value == false) {
        if (context.eventPayload?.command_sub == 'beer_buying') {
            ...
            const questuin_pull = [
                ...
                { location: "Хогвартс", name: "Гремучая Ива", quest: [ "Познакомиться с ветвями дерева", "Утроить бой с деревом", "Повесить конфеты на дерево", "Устроить показ мод", "Согреть иву с помощью шарфов", "Найти секретный вход в Хогсмид" ] }, 
                ...
                { location: "Хогвартс", name: "Туалет Плаксы Миртл", quest: [ "Познакомиться с местным призраком", "Выплакаться мисс Миртл", "Погадать на картах таро на свою судьбу", "Поиграть в карты с Миртл", "Узнать о судьбе призрака", "Подарить Праксе букет цветов", "Сделать зимний пейзаж зубной пастой на стенах" ] },
                ...
                { location: "Хогвартс", name: "Чердак", quest: [ "Сделать генеральную уборку", "Найти старинные украшения", "Прорепетировать ответ на уроке зельеварения", "Подготовить романтическое Свидание" ] },
